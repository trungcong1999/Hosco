...
<head>
    ...
    <link href="themes/default/assets/css/bootstrap4.min.css" type="text/css" rel="stylesheet"/>
    ...
    <link rel="stylesheet" href="themes/default/assets/css/swiper-bundle.min.css">
    <link href="themes/default/assets/css/animate.css" type="text/css" rel="stylesheet"/>
...
<link href="themes/default/assets/css/elegant-icons.min.css" type="text/css" rel="stylesheet"/>
<style>
...
<link href="themes/default/assets/css/style.css" type="text/css" rel="stylesheet"/>
<link href="themes/default/css/cnv.css" type="text/css" rel="stylesheet">
<link href="themes/default/css/cnv_new.css" type="text/css" rel="stylesheet">
<style>
...
<body class="">
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-PLFDCD7"
        ...
        <div class="wrapper">
                    ...
                    <nav class="navbar navbarmain-primary hidden-xs">
                        <div class="container-primary container-fluid">
                            <div class="wrapper-navbar-primary">
                                <div class="navsub-primary-menu flex-align-primary">
                                    ...
                                    <ul class="list-unstyled nav navbar-nav primary-menu">
                                        <li>
                                            <a href="blogs/tin-tuc/gioi-thieu-cnv-loyalty-tien-phong-nen-tang-cham-soc-khach-hang-1-vn.html">VỀ HOSCO</a>
                                        </li>
                                        <li>
                                            ...
                                            <ul class="cnv-submenu row">
                                                <div class="col-lg-6 col-xs-6 lineTransition">
                                                    ...
                                                    <div class="content-sub-menu">
                                                        <a class="title" href="product.html" title="">Phần mềm bán hàng Master Pro</a>
                                                    </div>
                                                </li>
                                                <li class="list-sub">
                            ...
                            <ul class="list-unstyled primary-button flex-align-primary">
                                <li>
                                    <a class="btn-menu-login btn-menu btn-hover-vertical btn-menu-loyalty" data-toggle="modal" data-target="#informationForm" href="#information-form">Trải nghiệm ngay</a>
                                </li>
                            </ul>
                        </div>
                    </div>
             ...
             <div class="container">
                <div class="row banner_main">
                    <div class="col-lg-6 event_banner_content">
                        ...
                        <h6 class="big_text_product">MASTER PRO</h6>
                        <h2 class="">PHẦN MỀM QUẢN LÝ BÁN HÀNG TỐT NHẤT HIỆN NAY Với hơn 10 năm kinh nghiệm trong lĩnh vực phát triển phần mềm và các giải pháp doanh nghiệp.</h2>
                        <a class="event_btn btn_hover" data-toggle="modal" data-target="#informationForm" href="#information-form"><img src="themes/default/images/template_new/calling.png" alt="" />Đăng ký tư vấn</a> <a class="event_btn event_btn_two btn_hover" data-toggle="modal" data-target="#informationForm" href="#information-form"><i class="arrow_triangle-right_alt2"></i>Dùng thử miễn phí</a></div>
                        <div class="col-lg-6 banner_main_img"><img src="themes/default/images/template_new/banner-main.png" alt="" /></div>
                    </div>
                </div>
            </section>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-3 col-md-3 col-sm-6 col-6 item_post_featured_banner four_post_bottom_banner_desktop">
                            <div class="item">
                                <div class="img">
                                    <img src="storage/news/loyalty-app-brand.png" alt="" title="">
                                </div>
                                <div class="ct">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-6 item_post_featured_banner four_post_bottom_banner_desktop">
                            <div class="item">
                                <div class="img">
                                    <img src="storage/news/cdp.png" alt="" title="">
                                </div>
                                <div class="ct">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-6 item_post_featured_banner four_post_bottom_banner_desktop">
                            <div class="item">
                                <div class="img">
                                    <img src="storage/news/app-nv.png" alt="" title="">
                                </div>
                                <div class="ct">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-6 item_post_featured_banner four_post_bottom_banner_desktop">
                            <div class="item">
                                <div class="img">
                                    <img src="storage/news/quan-ly-booking.png" alt="" title="">
                                </div>
                                <div class="ct">
                        ...
                        <div class="four_post_bottom_banner_mobile col-lg-3 col-md-3 col-sm-6 col-12">
                            <div class="item">
                                <div class="img">
                                    <img class="lazy" data-src="storage/news/loyalty-app-brand.png" alt="" title="">
                                </div>
                                <div class="ct">
                            ...
                            <div class="item">
                                <div class="img">
                                    <img class="lazy" data-src="storage/news/cdp.png" alt="" title="">
                                </div>
                                <div class="ct">
                            ...
                            <div class="item">
                                <div class="img">
                                    <img class="lazy" data-src="storage/news/app-nv.png" alt="" title="">
                                </div>
                                <div class="ct">
                                    <h3 class="title"><a class="smooth" href="#" title="">App cho nhân viên</a></h3>
                                    <p>App cho nhân viên, hoàn toàn miễn phí. Quản lý tập trung và khoa học, chỉ có tại CNV Loyalty.</p>
                            ...
                            <div class="item">
                                <div class="img">
                                    <img class="lazy" data-src="storage/news/quan-ly-booking.png" alt="" title="">
                                </div>
                                <div class="ct">
                                    <h3 class="title"><a class="smooth" href="#" title="">Quản lý Booking</a></h3>
                                    <p>Ứng dụng booking (trên IPAD) cho chủ doanh nghiệp, giúp quản lý đặt bàn, đặt chỗ của khách hàng</p>
                    ...
                    <div class="customers_partner customers_partner_desktop" >
                        <div id="jssor_1" style="margin:auto;width:1000px;height:100px;overflow:hidden;">        
                            <div data-u="slides" style="cursor:default;width:1000px;height:100px;overflow:hidden;" class="slider-ads">
                                <div>
                                    <img data-u="image" src="storage/avatars/mask-group.jpg" />
                                </div>
                                <div>
                                    <img data-u="image" src="storage/avatars/mask-group.jpg" />
                                </div>
            ...
            <section class="you_choose_cnv">
                <div class="container">
                    <div class="headbox">
                        <h2 class="title">Lý do bạn nên chọn Master Pro</h2>
                    </div>
                    <div class="row">
                        <div class="portfolio_choose_cnv">
                            <div class="img">
                                <a data-toggle="modal" data-target="#informationForm" href="#information-form"><img data-src="storage/ly-do-chon/hinh-ly-do-nen-chon-cnv.png" class="lazy" alt="" width="676" height="598" /></a>
                            </div>
                            <div class="items">
                                <div class="item">
                                    <h2>Độc quyền</h2>
                                    ...
                                    <section class="app_nen_tang" id="app-nen-tang">
                                        <div class="container">
                                            <div class="headbox">
                                                <h2 class="title">Hệ sinh thái Master Pro</h2>
                                            ...
                                            <div class="row group_content_he_sinh_thai">
                                               <div class="col-lg-3 thumbnail_app">
                                                   <img src="themes/default/images/template_new/he_sinh_thai_cong_ty.png" alt="">
                                               ...
                                               <div class="col-lg-9">
                                                <div class="tab-content">
                                                    <div class="item_tab tab-pane fade active show" id="tab1">
                                                        <div class="row">
                                                            <div class="col-lg-5 thumbnail_app_img">
                                                                <img class="lazy" data-src="themes/default/images/template_new/hinhanh_nen_tang.png" alt="">
                                                            </div>
                                                            <div class="col-lg-7 group_content_app">
                                                                <div class="content">
                                                                    <p><img class="lazy" data-src="themes/default/images/template_new/like_app_nghanh.png" alt=""> Là nơi để khách hàng và doanh nghiệp tương tác với nhau mà không phải thông qua một nền tảng thứ 3 nào khác.</p>
                                                                    <p><img class="lazy" data-src="themes/default/images/template_new/like_app_nghanh.png" alt=""> App được đặt tên theo Brandname của doanh nghiệp, tạo sự khác biệt với các thương hiệu đối thủ khác</p>
                                                                    <p><img class="lazy" data-src="themes/default/images/template_new/like_app_nghanh.png" alt=""> Khách hàng có thể quản lý được lịch sử mua hàng, điểm tích luỹ, được cập nhập các chương trình khuyến mãi, thông báo của doanh nghiệp..</p>
                                                                    <p><img class="lazy" data-src="themes/default/images/template_new/like_app_nghanh.png" alt=""> Nhận feedback từ khách hàng một cách nhanh chóng, hạn chế tạo ra bad review khó khắc phục như trước đây.</p>
                                                                    <p><img class="lazy" data-src="themes/default/images/template_new/like_app_nghanh.png" alt=""> Nhờ tính năng Call-in-app, khách hàng có thể liên hệ trực tiếp đến bộ phận chăm sóc khách hàng giúp tiết kiệm được chi phí hạ tầng call center</p>
                                                                    <p><img class="lazy" data-src="themes/default/images/template_new/like_app_nghanh.png" alt=""> Tăng sự trải nghiệm, tạo sự yêu thích, dẫn đến sự trung thành một cách chủ động</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="item_tab tab-pane fade" id="tab2">
                                                        <div class="row">
                                                            <div class="col-lg-5 thumbnail_app_img">
                                                                <img src="themes/default/images/template_new/quan_ly_book.png" alt="">
                                                            </div>
                                                            <div class="col-lg-7 group_content_app">
                                                                <div class="content">
                                                                    <p><img class="lazy" data-src="themes/default/images/template_new/like_app_nghanh.png" alt=""> Nhận thông tin đặt lịch, đặt hàng nhanh chóng từ khách hàng</p>
                                                                    <p><img class="lazy" data-src="themes/default/images/template_new/like_app_nghanh.png" alt=""> Nhận thông báo khi có nhiệm vụ mới cần xử lý  </p>
                                                                    <p><img class="lazy" data-src="themes/default/images/template_new/like_app_nghanh.png" alt=""> Thực hiện nhiệm vụ, chụp hình trạng thái khách, trước và sau khi phục vụ </p>
                                                                    <p><img class="lazy" data-src="themes/default/images/template_new/like_app_nghanh.png" alt=""> Quản lý, phân loại, xem báo cáo danh sách khách hàng đã/ đang/ sẽ phục vụ, từ đó đưa ra những quyết định phù hợp.</p>
                                                                    <p><img class="lazy" data-src="themes/default/images/template_new/like_app_nghanh.png" alt=""> Đơn giản hoá, tiết kiệm thời gian các công việc liên quan đến thống kê, báo cáo, ... giúp việc quy trình vận hành tại chi nhánh tinh giản, hiệu quả</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="item_tab tab-pane fade" id="tab3">
                                                        <div class="row">
                                                            <div class="col-lg-5 thumbnail_app_img">
                                                                <img src="themes/default/images/template_new/app_nhan_vien.png" alt="">
                                                            </div>
                                                            <div class="col-lg-7 group_content_app">
                                                                <div class="content">
                                                                    <p><img class="lazy" data-src="themes/default/images/template_new/like_app_nghanh.png" alt=""> Quản lý sơ đồ bàn</p>
                                                                    <p><img class="lazy" data-src="themes/default/images/template_new/like_app_nghanh.png" alt=""> Quản  lý timeline các bàn đang còn trống</p>
                                                                    <p><img class="lazy" data-src="themes/default/images/template_new/like_app_nghanh.png" alt=""> Quản lý ưu đãi của quán và khách</p>
                                                                    <p><img class="lazy" data-src="themes/default/images/template_new/like_app_nghanh.png" alt=""> Quản lý lịch sử booking của khách hàng</p>
                                                                    <p><img class="lazy" data-src="themes/default/images/template_new/like_app_nghanh.png" alt=""> Quản lý thẻ gửi rượu</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                            ...
                            <section class="app_nghanh_hang" id="nganh-hang">
                                <div class="container">
                                    <div class="headbox">
                                        <h2 class="title">Master Pro - Tối ưu từng ngành hàng</h2>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-3">
                                            <ul class="nav_app nav">
                                                <li>
                                                    <a data-toggle="tab" class="smooth active" href="#app-nganh-retail" title="">
                                                     <img class="icon_app lazy" data-src="storage/nghanh-hang/nghanh-ban-le.png" alt="">
                                                     App Ngành Retail
                                                 </a>
                                             </li>
                                             <li>
                                         ...
                                         <li>
                                            <a data-toggle="tab" class="smooth " href="#app-nganh-fitness" title="">
                                             <img class="icon_app lazy" data-src="storage/nghanh-hang/nghanh-fitness.png" alt="">
                                             App Ngành Fitness
                                         </a>
                                     </li>
                                     <li>
                        ...
                        <div class="item_tab tab-pane fade active show" id="app-nganh-retail">
                            <div class="row">
                                ...
                                <div class="col-lg-7 group_content_app">
                                    ...
                                    <div class="content">
                                        <p><img src="themes/default/images/template_new/like_app_nghanh.png" alt="" /><span>Xây dựng chương trình khách hàng thân thiết, tích điểm, đổi quà</span></p>
                                        <p><img src="themes/default/images/template_new/like_app_nghanh.png" alt="" /><span >Tính năng ecommerce: mua hàng, quản lý đơn hàng tại App</span></p>
                                        <p><img src="themes/default/images/template_new/like_app_nghanh.png" alt="" /><span >Kết nối với các cổng thanh toán, vận chuyển, CRM, POS, ERP,..</span></p>
                                        <p><img src="themes/default/images/template_new/like_app_nghanh.png" alt="" /><span >Tìm kiếm cửa hàng/chi nhánh gần nhất</span></p>
                                        <p><img src="themes/default/images/template_new/like_app_nghanh.png" alt="" /><span >Chức năng cấp mã bảo hành online ( thay thế thẻ bảo hành truyền thống)</span></p>
                                    </div>
                        ...
                        <div class="item_tab tab-pane fade " id="app-nganh-f-b">
                            <div class="row">
                                ...
                                <div class="col-lg-7 group_content_app">
                                    ...
                                    <div class="content">
                                        <p><img src="themes/default/images/template_new/like_app_nghanh.png" alt="" /><span >Khách hàng có thể chủ động đặt bàn, doanh nghiệp dễ dàng quản lý lịch đặt</span></p>
                                        <p><img src="themes/default/images/template_new/like_app_nghanh.png" alt="" /><span >Đặt món online, áp dụng cho cả giao tận nơi và khách đến lấy</span></p>
                                        <p><img src="themes/default/images/template_new/like_app_nghanh.png" alt="" /><span >Đưa cả cửa hàng lên app bằng tính năng Topping độc quyền</span></p>
                                        <p><img src="themes/default/images/template_new/like_app_nghanh.png" alt="" /><span >Tự động gợi ý các món ăn/ thức uống liên quan</span></p>
                                        <p><img src="themes/default/images/template_new/like_app_nghanh.png" alt="" /><span >Đánh giá, khảo sát độ hài lòng khách hàng sau khi sử dụng/ dùng bữa</span></p>
                                        <p><span ><img src="themes/default/images/template_new/like_app_nghanh.png" alt="" />Gửi thông tin về các chương trình ưu đãi</span></p>
                                    </div>
                                    <div class="view_app_details">
                                        <a href="index.html">Xem thêm</a>
                                    </div>
                        ...
                        <div class="item_tab tab-pane fade " id="app-nganh-fitness">
                            <div class="row">
                                ...
                                <div class="col-lg-7 group_content_app">
                                    ...
                                    <div class="content">
                                        <p><img src="themes/default/images/template_new/like_app_nghanh.png" alt="" /> Thay thế thẻ member cứng, chật ví giúp tích điểm, thăng hạng dễ dàng</p>
                                        <p><img src="themes/default/images/template_new/like_app_nghanh.png" alt="" /><span>Tính năng check-in bằng QR Code thay thế máy móc cồng kềnh</span></p>
                                        <p><img src="themes/default/images/template_new/like_app_nghanh.png" alt="" /><span >Khách hàng có thể mua gói tập và quản lý gói tập ngay tại app</span></p>
                                        <p><img src="themes/default/images/template_new/like_app_nghanh.png" alt="" /><span>Đặt lịch tập, chọn PT, chọn phòng tập mong muốn</span></p>
                                        <p><img src="themes/default/images/template_new/like_app_nghanh.png" alt="" /><span>Tính năng topup nạp trước dùng sau sang trọng đẳng cấp</span></p>
                                    </div>
                                    <div class="view_app_details">
                                        <a href="index.html">Xem thêm</a>
                                    </div>
                        ...
                        <div class="item_tab tab-pane fade " id="app-nganh-spa">
                            <div class="row">
                                ...
                                <div class="col-lg-7 group_content_app">
                                    ...
                                    <div class="content">
                                        <p><img src="themes/default/images/template_new/like_app_nghanh.png" alt="" /><span>Khách hàng chủ động việc đặt lịch hẹn/chọn kỹ thuật viên, doanh nghiệp quản lý được lịch đặt</span></p>
                                        <p><img src="themes/default/images/template_new/like_app_nghanh.png" alt="" /><span>Tính năng mua &amp; quản lý liệu trình, tự động trừ đi số lần đã sử dụng</span></p>
                                        <p><img src="themes/default/images/template_new/like_app_nghanh.png" alt="" /><span>Lưu trữ ảnh trước và sau để củng cố thêm niềm tin vào dịch vụ</span></p>
                                        <p><img src="themes/default/images/template_new/like_app_nghanh.png" alt="" /><span>Thông báo ra mắt dịch vụ/liệu trình/chính sách mới</span></p>
                                        <p><img src="themes/default/images/template_new/like_app_nghanh.png" alt="" /><span>Cập nhật sớm nhất những chương trình khuyến mãi, ưu đãi.</span></p>
                                    </div>
                                    <div class="view_app_details">
                                        <a href="index.html">Xem thêm</a>
                                    </div>
                        ...
                        <div class="item_tab tab-pane fade " id="app-nganh-auto">
                            <div class="row">
                                ...
                                <div class="col-lg-7 group_content_app">
                                    ...
                                    <div class="content">
                                        <p><img src="themes/default/images/template_new/like_app_nghanh.png" alt="" /><span>Số hoá thẻ cứng bảo dưỡng sang tài khoản thành viên hiện tại.</span></p>
                                        <p><img src="themes/default/images/template_new/like_app_nghanh.png" alt="" /><span>Mua gói bảo hành/ bảo trì/ bảo dưỡng đơn giản ngay tại app.</span></p>
                                        <p><img src="themes/default/images/template_new/like_app_nghanh.png" alt="" /><span>Đặt lịch/ quản lý lịch hẹn chăm sóc xe với những thao tác dễ dàng</span></p>
                                        <p><img src="themes/default/images/template_new/like_app_nghanh.png" alt="" /><span>Lưu trữ đầy đủ lịch sử việc chăm sóc xe tại cửa hàng, nắm được thời gian tái bảo dưỡng, phụ kiện đã thay thế.</span></p>
                                        <p><img src="themes/default/images/template_new/like_app_nghanh.png" alt="" /><span>Tính năng phát sinh sửa chữa giúp khách hàng nhận báo giá nhanh chóng.</span></p>
                                    </div>
                                    <div class="view_app_details">
                                        <a href="index.html">Xem thêm</a>
                                    </div>
                        ...
                        <div class="item_tab tab-pane fade " id="nganh-hospitality">
                            <div class="row">
                                ...
                                <div class="col-lg-7 group_content_app">
                                    ...
                                    <div class="content">
                                        <p><img src="themes/default/images/template_new/like_app_nghanh.png" alt="" /><span>Khách hàng có thể chủ động đặt phòng mà không cần gọi trước hotline</span></p>
                                        <p><img src="themes/default/images/template_new/like_app_nghanh.png" alt="" /><span>Dễ dàng booking các dịch vụ trang trí, sản phẩm hỗ trợ, hoặc dịch vụ liên quan</span></p>
                                        <p><img src="themes/default/images/template_new/like_app_nghanh.png" alt="" /><span>Lưu trữ thông tin cá nhân hỗ trợ cho việc bỏ qua bước xác minh giấy tờ</span></p>
                                        <p><img src="themes/default/images/template_new/like_app_nghanh.png" alt="" /><span>Tính năng topup nạp trước dùng sau sang trọng đẳng cấp</span></p>
                                        <p><img src="themes/default/images/template_new/like_app_nghanh.png" alt="" /><span>Liên hệ dễ dàng với tổng đài, lễ tân thông qua tính năng call-in-app</span></p>
                                    </div>
                                    <div class="view_app_details">
                                        <a href="index.html">Xem thêm</a>
                                    </div>
                ...
                <div class="col-lg-12 group_link_dang_ky">
                    <a class="event_btn btn_hover" data-toggle="modal" data-target="#informationForm" href="#information-form"><img class="lazy" data-src="themes/default/images/template_new/calling.png" alt="" />Đăng ký tư vấn</a> <a class="event_btn event_btn_two btn_hover" data-toggle="modal" data-target="#informationForm" href="#information-form"><i class="arrow_triangle-right_alt2"></i>Dùng thử miễn phí</a>
                </div>
            </div>
        </div>
    </section>
    <section class="enterprise_solutions">
        <div class="container">
            ...
            <div class="row">
                <div class="portfolio">
                    <div class="img">
                        <img class="lazy" data-src="storage/giap-phap-so-1/giai-phap-doanh-nghiep.png" alt="" width="591" height="679" />
                    </div>
                    <div class="items solution_app_desktop">
                        <div class="item">
                            <a href="index.html"><img class="lazy" data-src="storage/giai-phap-so-1-tao-app/icon-tich-diem.png" alt=""></a>
                        ...
                        <div class="item">
                            <a href="index.html"><img class="lazy" data-src="storage/giai-phap-so-1-tao-app/icon-marketing-0-dong.png" alt=""></a>
                        ...
                        <div class="item">
                            <a href="index.html"><img class="lazy" data-src="storage/giai-phap-so-1-tao-app/icon-ca-nhan-hoa.png" alt=""></a>
                        ...
                        <div class="item">
                            <a href="index.html"><img class="lazy" data-src="storage/giai-phap-so-1-tao-app/icon-bao-cao-du-lieu.png" alt=""></a>
            ...
            <div class="row row_group">
                <div class="case_study col-lg-12">
                    <div class="items row">
                        ...
                        <div class="col-md-4">
                            <div class="t-icon">
                                <img class="lazy" data-src="storage/comfit.jpg"  alt="" title="">
                            </div>
                        </div>
...
<script src="themes/default/assets/js/jquery.matchheight.js" defer></script>
<script src="themes/default/js/script.js" defer></script>
<script src="themes/default/js/jscolor.js"></script>
<script src="themes/default/js/cnv.js" defer></script>
<script>
...
<script src="assets/css/owl.carousel.js"></script>
<script>
