                 ...
                 <div class="col-lg-9 offset-lg-3 group_tab_app_nen_tang">
                        <ul class="nav_app nav">
                                ...
                                <?php foreach (get_post_meta( get_post()->ID,'_he_sinh_thai', $single = true ) as  $value) {
                                        ...
                                        if($kt ==FALSE){
                                                echo "<li><a data-toggle='tab' class='smooth active' href='#".get_post($value)->post_name."' title=''>Lotus Pro</a></li>";
                                                $kt = TRUE;
                                        }
                                        else{
                                                echo "<li><a data-toggle='tab' class='smooth ' href='#".get_post($value)->post_name."' title=''>Lotus Pro</a></li>";
                                        }
                                } ?>
