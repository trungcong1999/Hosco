   ...
   <div class="container">
    <div class="row banner_main">
        <div class="col-lg-6 event_banner_content">
            ...
            <h2 class="">Phần mềm quản lý nhân sự Lotus Pro tốt nhất hiện nay Bài toán nhân sự luôn là vấn đề quan trọng nhất đối với các doanh nghiệp vừa và lớn.</h2>
        ...
        <div class="row">
            <div class="portfolio_choose_cnv">
                ...
                <section class="app_nghanh_hang" id="nganh-hang">
                    <div class="container">
                        <div class="headbox">
                            <h2 class="title">Lotus - Tối ưu từng ngành hàng</h2>
                        </div>
                        <div class="row">
                            <div class="col-lg-3">
                                <ul class="nav_app nav">
