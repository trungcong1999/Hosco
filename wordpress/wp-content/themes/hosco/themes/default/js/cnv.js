...
$(document).ready(function () {
	...
	$(".case_study").slick({
		...
		autoplaySpeed: 6000,
		arrows: true,
		nextArrow: '<img src="'+window.location.href+'/wp-content/themes/hosco/themes/default/images/template_new/arrow_right_circle.png" class="next" alt="Next">',
		prevArrow: '<img src="'+window.location.href+'/wp-content/themes/hosco/themes/default/images/template_new/arrow_left_circle.png" class="prev" alt="Prev">',
		responsive: [{
			breakpoint: 768,
			settings: {
				slidesToShow: 1,
