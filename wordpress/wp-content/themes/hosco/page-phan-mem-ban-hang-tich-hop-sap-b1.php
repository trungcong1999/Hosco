   ...
   <div class="container">
    <div class="row banner_main">
        <div class="col-lg-6 event_banner_content">
            ...
            <h6 class="big_text_product">SAP B1</h6>
            <h2 class="">Giải pháp Phần mềm quản lý hệ thống phân phối SAP B1 Phần mềm quản lý hệ thống phân phối SAP B1 là  sản phẩm giúp cho các giám đốc kinh doanh quản lý, giám sát hoạt động kinh doanh của hệ thống phân phối hiệu quả, tăng doanh số bán hàng.</h2>
...
<section class="you_choose_cnv">
    <div class="container">
        <div class="headbox">
            <h2 class="title">Lý do bạn nên chọn SAP B1</h2>
        </div>
        <div class="row">
            <div class="portfolio_choose_cnv">
                ...
                <div class="items">
                    <div class="item">
                        ...
                        <section class="app_nen_tang" id="app-nen-tang">
                            <div class="container">
                                <div class="headbox">
                                    <h2 class="title">Hệ sinh thái SAP B1</h2>
                                ...
                                <div class="row group_content_he_sinh_thai">
                                 <div class="col-lg-3 thumbnail_app">
                                     ...
                                     <p class="title_he_sinh_thai">Hệ sinh thái SAP B1</p>
                                 </div>
                                 <div class="col-lg-9">
                ...
                <section class="app_nghanh_hang" id="nganh-hang">
                    <div class="container">
                        <div class="headbox">
                            <h2 class="title">SAP B1 - Tối ưu từng ngành hàng</h2>
                        </div>
                        <div class="row">
                            <div class="col-lg-3">
                                <ul class="nav_app nav">
