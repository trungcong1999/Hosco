   ...
   <div class="container">
    <div class="row banner_main">
        <div class="col-lg-6 event_banner_content">
            <h6 class="">Phần mềm</h6>
            <h6 class="big_text_product">GYM MASTER</h6>
            <h2 class="">Giải pháp Phần mềm quản lý hệ thống phân phối Gym Master Phần mềm quản lý hệ thống phân phối Gym Master là  sản phẩm giúp cho các giám đốc kinh doanh quản lý, giám sát hoạt động kinh doanh của hệ thống phân phối hiệu quả, tăng doanh số bán hàng.</h2>
...
<section class="you_choose_cnv">
    <div class="container">
        <div class="headbox">
            <h2 class="title">Lý do bạn nên chọn Gym Master</h2>
        </div>
        <div class="row">
            <div class="portfolio_choose_cnv">
                ...
                <div class="items">
                    <div class="item">
                        ...
                        <section class="app_nen_tang" id="app-nen-tang">
                            <div class="container">
                                <div class="headbox">
                                    <h2 class="title">Hệ sinh thái Gym Master</h2>
                                ...
                                <div class="row group_content_he_sinh_thai">
                                 <div class="col-lg-3 thumbnail_app">
                                     ...
                                     <p class="title_he_sinh_thai">Hệ sinh thái Gym Master</p>
                                 </div>
                                 <div class="col-lg-9">
                ...
                <section class="app_nghanh_hang" id="nganh-hang">
                    <div class="container">
                        <div class="headbox">
                            <h2 class="title">Gym Master - Tối ưu từng ngành hàng</h2>
                        </div>
                        <div class="row">
                            <div class="col-lg-3">
                                <ul class="nav_app nav">
